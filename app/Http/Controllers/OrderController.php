...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $request->validate([
        ...
        'nickname'                       => 'required|min:3|alpha',
        'fnameenglish'                   => 'required|min:3|alpha|regex:/^[A-Za-z][A-Za-z]*$/',
        'lnameenglish'                   => 'required|min:3|alpha|regex:/^[A-Za-z][A-Za-z]*$/',
        'fathername'                     => 'required|min:3|alpha',
        'grandfathername'                => 'required|min:3|alpha',
        'mothername'                     => 'required|min:3|alpha',
        'gender'                         => 'nullable',
        'fathernameenglish'              => 'required|min:3|alpha|regex:/^[A-Za-z][A-Za-z]*$/',
        'mothernameenglish'              => 'required|min:3|alpha|regex:/^[A-Za-z][A-Za-z]*$/',
