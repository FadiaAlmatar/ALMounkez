...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $request->validate([
        ...
        'fnameenglish'                   => 'required|min:3|regex:/^[A-Za-z_ ]*$/',
        'lnameenglish'                   => 'required|min:3|regex:/^[A-Za-z_ ]*$/',
        'fathername'                     => 'required|min:3',
        'grandfathername'                => 'required|min:3',
        'mothername'                     => 'required|min:3',
        'gender'                         => 'nullable',
        'fathernameenglish'              => 'required|min:3|regex:/^[A-Za-z_ ]*$/',
        'mothernameenglish'              => 'required|min:3|regex:/^[A-Za-z_ ]*$/',
