...
<html>
    ...
    <body>
        ...
        <hr>
        <p style="font-weight: bold;">{{__('Branch financial management statement:')}}</p>
        ...
        <hr><p style="font-weight: bold;">{{__('Branch Treasurer Statement: ')}}</p>
        <p>{{__('Amount has been received ')}}{{ $fullorder->money_order}}{{__(' SYP')}}</p>
        <hr><p style="font-weight: bold">{{__('Treasurer Statement/central: ')}}</p>
            <p>{{__('Amount has been received ')}}{{ $fullorder->money_central}}{{__(' SYP')}}</p>
